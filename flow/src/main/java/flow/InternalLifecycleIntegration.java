...
public final class InternalLifecycleIntegration extends Fragment {
    ...
    // get this InternalLifecycleIntergration(fragment)
    ...
    static void install(final Application app, final Activity activity,
        ...
        // use application to register this to activity's Life cycle,in onActivityCreated(onCreate())
        // this be called on App's Activity's attachBaseContext() which execute before onCreate()
        app.registerActivityLifecycleCallbacks(new Application.ActivityLifecycleCallbacks() {
            ...
            public void onActivityCreated(Activity a, Bundle savedInstanceState) {
                if (a == activity) {
                    ...
                    // there is no layoutId identifier, so fragment cannot be shown, only associated with activity
                    if (newFragment) {
                    ...
                    // after register to execute above on code, unregister
    ...
    public InternalLifecycleIntegration() {
        super();
        // retain state when activity re-creation
